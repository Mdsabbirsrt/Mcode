...
#import requests
    ...
    'referer': 'https://www.happyscribe.com/v2/12258043/checkout?new_subscription_interval=month&plan=basic_2023_05_01&step=billing_details',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-platform': '"Android"',
...
,
    ...
    'orderReference': 'sogpbdlcj',
    'user_id': 11937115,
    'organization_id': 12258043,
    'hours': 0,
    'balance_increase_in_cents': None,
    'payment_method_id': 'pm_1QD7iwKEzvleW5fl3dMFBu2G',  # Replace with actual ID
